...
A modern customer relationship management system built with Laravel and Filament.

## Features

- **CRM** - Manage companies, contacts, and deals in one centralized platform
- **Tenancy** - Multi-tenant architecture for isolated workspaces
